...
class Pagination extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if ((this.props.items !== undefined && this.props.items !== null && JSON.stringify(this.props.items) !== JSON.stringify(prevProps.items)) || (this.props.pageSize !== prevProps.pageSize)) {
        this.setPage(this.props.initialPage);
    }
  }
